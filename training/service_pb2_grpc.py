...
class RegistrationStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RegisterWorker = channel.unary_unary(
                ...
                request_serializer=service__pb2.WorkerInfo.SerializeToString,
...
def add_RegistrationServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RegisterWorker': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=service__pb2.WorkerInfo.FromString,
...
class Registration(object):
    ...
    def RegisterWorker(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Registration/RegisterWorker',
            service__pb2.WorkerInfo.SerializeToString,
