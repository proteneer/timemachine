...
if __name__ == "__main__":
    ...
    pair_data.append((data[0], data[1]))
    pair_data.append((data[1], data[0]))
    pair_data.append((data[0], data[1]))
    pair_data.append((data[1], data[0]))
    pair_data.append((data[0], data[1]))
    pair_data.append((data[1], data[0]))
    ...
    for epoch in range(100):
        ...
        for idx, (((mol_a, label_a_dG, label_a_err), (mol_b, label_b_dG, label_b_err)), inference) in enumerate(all_data):
            ...
            potentials, masses, vjp_fns = septop_setup.combine_potentials(
                ff_handlers,
                mol_a,
                mol_b,
                host_system,
            ...
            coords = septop_setup.combine_coordinates(
                host_coords,
                mol_a,
                mol_b
            )
