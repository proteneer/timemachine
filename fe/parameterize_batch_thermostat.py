...
from fe import loss, bar, dataset
...
if __name__ == "__main__":
    ...
    for ligand_sdf_file in args.ligand_sdf:
        for rd_mol in Chem.SDMolSupplier(ligand_sdf_file, removeHs=False):
            ...
            mol_name = rd_mol.GetProp("s_user_Name")
            ligand_list.append((rd_mol, float(dG_value), mol_name))
            ...
            for id, data in enumerate(dataset.iterbatches(1)):
                ...
                for trial_idx in range(args.num_trials):
                    ...
                    if epoch % 10 == 0:
                        ...
                        out_file = os.path.join(args.out_dir, "epoch_"+str(epoch)+"_"+str(job_name)+"_"+str(name)+"_insert_"+str(trial_idx)+".pdb")
