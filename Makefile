...
COMPUTE_SANITIZER_CMD := compute-sanitizer --launch-timeout 120 --force-synchronization-limit 2000 --padding 2048 --tool memcheck --leak-check full --error-exitcode 1
