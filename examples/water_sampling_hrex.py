...
def estimate_relative_free_energy_hrex(
    ...
    initial_states_hrex = [
        ...
        for initial_state, traj in zip(results_bisection[-1].initial_states, trajectories_by_state)
    ]
    ...
    return SimulationResult(pair_bar_result, plots, trajectories_by_state, md_params, None, diagnostics)
...
def test_hrex():
    ...
    plot_hrex_swap_acceptance_rates_convergence(sim_res.hrex_diagnostics.cumulative_swap_acceptance_rates)
    # plot_hrex_swap_acceptance_rates_convergence(sim_res.hrex_diagnostics.instantaneous_swap_acceptance_rates)
