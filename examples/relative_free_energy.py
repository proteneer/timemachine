...
def run_pair(mol_a, mol_b, core, forcefield, n_frames, protein_path, seed):
    ...
    box_width = 4.0
    solvent_sys, solvent_conf, solvent_box, solvent_top = builders.build_water_system(box_width, forcefield)
    ...
    complex_sys, complex_conf, _, _, complex_box, complex_top = builders.build_protein_system(protein_path, forcefield)
