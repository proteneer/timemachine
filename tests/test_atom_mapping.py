...
from timemachine.fe.atom_mapping import get_core_by_mcs, mcs_conformer_aware
from timemachine.testsystems.relative import hif2a_ligand_pair


def test_mcs_map():
    mcs_result = mcs_conformer_aware(hif2a_ligand_pair.mol_a, hif2a_ligand_pair.mol_b, threshold=0.5)
...
def test_get_core_by_mcs():
    ...
    query = mcs_conformer_aware(mol_a, mol_b).queryMol
...
def test_ring_size_change():
    ...
    mcs_result = mcs_conformer_aware(mol_a, mol_b)
