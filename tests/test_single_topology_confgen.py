...
from timemachine.fe.rbfe import HostConfig, setup_initial_states_upfront
...
def run_edge(mol_a, mol_b, protein_path, n_windows):
    ...
    initial_states = setup_initial_states_upfront(st, solvent_host_config, DEFAULT_TEMP, lambda_schedule, seed)
    ...
    initial_states = setup_initial_states_upfront(st, complex_host_config, DEFAULT_TEMP, lambda_schedule, seed)
