...
def test_nonbonded_mol_energy_matches_jax_batch(num_mols, precision, atol, rtol):
    """Assert that unsummed nonbonded_block Cuda implementation produces the same
    energies as the reference jax version"""
    ...
    mover = exchange_mover.BDExchangeMove(beta, cutoff, params, group_idxs, DEFAULT_TEMP)
