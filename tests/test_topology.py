...
class ImproperTorsionTest(unittest.TestCase):
    ...
    def test_improper_torsions_full_core(self):
        ...
        (src_params, dst_params), vjp_fn, (src_potential, dst_potential) = jax.vjp(st.parameterize_improper_torsion, self.ff.it_handle.params, has_aux=True)

        print(params, potential)
