nvcc -std=c++11  --ptxas-options=-v -lineinfo -G -arch=sm_61 -Xcompiler -fPIC -I ~/Code/timemachine/timemachine/cpu_functionals/ gpu/custom_bonded_gpu.cu  gpu/custom_nonbonded_gpu.cu gpu/potential.cu -c
