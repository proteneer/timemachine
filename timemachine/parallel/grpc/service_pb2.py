...
# source: timemachine/parallel/grpc/service.proto
...
PickleData = _reflection.GeneratedProtocolMessageType('PickleData', (_message.Message,), {
  ...
  '__module__' : 'timemachine.parallel.grpc.service_pb2'
