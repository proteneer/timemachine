...
class Context:
    ...
    def local_md(self, lambda_schedule: numpy.typing.NDArray[numpy.float64], iterations: int, global_steps: int, local_steps: int, store_x_interval: int, local_idxs: numpy.typing.NDArray[numpy.uint32], cutoff: float = ...) -> tuple: ...
...
class NonbondedAllPairs_f32(Potential):
    def __init__(self, kernel_dir: str, lambda_plane_idxs_i: numpy.typing.NDArray[numpy.int32], lambda_offset_idxs_i: numpy.typing.NDArray[numpy.int32], beta: float, cutoff: float, atom_idxs_i: Optional[numpy.typing.NDArray[numpy.uint32]] = ..., transform_lambda_charge: str = ..., transform_lambda_sigma: str = ..., transform_lambda_epsilon: str = ..., transform_lambda_w: str = ...) -> None: ...
