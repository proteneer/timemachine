...
class PotentialExecutor:
    def __init__(self, num_atoms: int, parallel: bool = ...) -> None: ...
    def execute_bound(self, bps: List[BoundPotential], coords: numpy.typing.NDArray[numpy.float64], box: numpy.typing.NDArray[numpy.float64], compute_du_dx: bool = ..., compute_u: bool = ...) -> tuple: ...
    def execute_unbound(self, pots: List[Potential], param_sizes: numpy.typing.NDArray[numpy.int32], coords: numpy.typing.NDArray[numpy.float64], params: numpy.typing.NDArray[numpy.float64], box: numpy.typing.NDArray[numpy.float64], compute_du_dx: bool = ..., compute_du_dp: bool = ..., compute_u: bool = ...) -> tuple: ...
