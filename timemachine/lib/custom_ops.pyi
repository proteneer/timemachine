...
class BDExchangeMove_f32(Mover):
    ...
    def compute_incremental_weights(self, coords: numpy.typing.NDArray[numpy.float64], box: numpy.typing.NDArray[numpy.float64], mol_idxs: numpy.typing.NDArray[numpy.int32], quaternions: numpy.typing.NDArray[numpy.float64], translation: numpy.typing.NDArray[numpy.float64]) -> List[List[float]]: ...
...
class TIBDExchangeMove_f32(BDExchangeMove_f32):
    def __init__(self, N: int, ligand_idxs: List[int], target_mols: List[List[int]], params: numpy.typing.NDArray[numpy.float64], temperature: float, nb_beta: float, cutoff: float, radius: float, seed: int, num_proposals_per_move: int, interval: int) -> None: ...
