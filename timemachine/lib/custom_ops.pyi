...
class Context:
    ...
    def multiple_steps_local(self, n_steps: int, local_idxs: numpy.typing.NDArray[numpy.int32], store_x_interval: int = ..., radius: float = ..., k: float = ..., temperature: float = ..., seed: int = ...) -> tuple: ...
