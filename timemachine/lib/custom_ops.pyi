...
class BDExchangeMove_f32:
    def __init__(self, N: int, target_mols: List[List[int]], params: numpy.typing.NDArray[numpy.float64], temperature: float, nb_beta: float, cutoff: float, seed: int, proposals_per_move: int) -> None: ...
