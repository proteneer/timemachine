...
class Context:
    ...
    def initialize_local_md(self) -> None: ...
    ...
    def multiple_steps_local_selection(self, n_steps: int, reference_idx: int, selection_mask: numpy.typing.NDArray[numpy.int32], burn_in: int = ..., store_x_interval: int = ..., radius: float = ..., k: float = ...) -> tuple: ...
