...
class Context:
    ...
    def multiple_steps_local(self, local_steps: int, local_idxs: numpy.typing.NDArray[numpy.int32], store_x_interval: int = ..., radius: float = ..., k: float = ..., temperature: float = ..., seed: int = ...) -> tuple: ...
...
class NonbondedAllPairs_f32(Potential):
    def __init__(self, num_atoms: int, beta: float, cutoff: float, atom_idxs_i: Optional[numpy.typing.NDArray[numpy.int32]] = ...) -> None: ...
    def disable_hilbert_sort(self) -> None: ...
    def set_atom_idxs(self, arg0: List[int]) -> None: ...
...
class NonbondedInteractionGroup_f32(Potential):
    def __init__(self, num_atoms: int, row_atom_idxs_i: numpy.typing.NDArray[numpy.int32], beta: float, cutoff: float) -> None: ...
    def disable_hilbert_sort(self) -> None: ...
    def set_nblist_padding(self, val: float) -> None: ...
