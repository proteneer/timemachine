...
class Context:
    ...
    def multiple_steps_local(self, lambda_schedule: numpy.typing.NDArray[numpy.float64], local_idxs: numpy.typing.NDArray[numpy.uint32], store_x_interval: int = ..., radius: float = ..., k: float = ..., temperature: float = ..., seed: int = ...) -> tuple: ...
