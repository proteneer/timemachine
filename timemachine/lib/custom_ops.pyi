...
class InsideOutsideExchangeMover:
    def __init__(self, nb_beta: float, nb_cutoff: float, nb_params: List[float], water_idxs: List[int], ligand_idxs: List[int], beta: float, radius: float) -> None: ...
    def get_water_groups(self, arg0: numpy.typing.NDArray[numpy.float64], arg1: numpy.typing.NDArray[numpy.float64], arg2: numpy.typing.NDArray[numpy.float64]) -> tuple: ...
    def propose(self, arg0: numpy.typing.NDArray[numpy.float64], arg1: numpy.typing.NDArray[numpy.float64]) -> tuple: ...
    def swap_vi_into_vj_impl(self, arg0: int, arg1: int, arg2: int, arg3: numpy.typing.NDArray[numpy.float64], arg4: numpy.typing.NDArray[numpy.float64], arg5: numpy.typing.NDArray[numpy.float64], arg6: float, arg7: float) -> tuple: ...
