...
class BDExchangeMove_f32:
    def __init__(self, N: int, target_mols: List[List[int]], params: numpy.typing.NDArray[numpy.float64], temperature: float, nb_beta: float, cutoff: float, seed: int) -> None: ...
    def move(self, coords: numpy.typing.NDArray[numpy.float64], box: numpy.typing.NDArray[numpy.float64], n_steps: int) -> tuple: ...

class BDExchangeMove_f64:
    def __init__(self, N: int, target_mols: List[List[int]], params: numpy.typing.NDArray[numpy.float64], temperature: float, nb_beta: float, cutoff: float, seed: int) -> None: ...
    def move(self, coords: numpy.typing.NDArray[numpy.float64], box: numpy.typing.NDArray[numpy.float64], n_steps: int) -> tuple: ...
...
class MonteCarloBarostat:
    def __init__(self, N: int, pressure: float, temperature: float, group_idxs: List[List[int]], frequency: int, bps, seed: int, adaptive_scaling_enabled: bool, initial_volume_scale_factor: float) -> None: ...
    def get_adaptive_scaling(self) -> bool: ...
    def get_interval(self) -> int: ...
    def get_volume_scale_factor(self) -> float: ...
    def move_host(self, coords: numpy.typing.NDArray[numpy.float64], box: numpy.typing.NDArray[numpy.float64]) -> tuple: ...
