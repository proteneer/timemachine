...
class BDExchangeMove_f32(Mover):
    def __init__(
        self,
        N: int,
        target_mols: List[List[int]],
        params: numpy.typing.NDArray[numpy.float64],
        temperature: float,
        nb_beta: float,
        cutoff: float,
        seed: int,
        num_proposals_per_move: int,
        interval: int,
        batch_size: int = ...,
    ) -> None: ...
    def acceptance_fraction(self) -> float: ...
    def batch_size(self) -> int: ...
    def compute_incremental_log_weights(
        self,
        coords: numpy.typing.NDArray[numpy.float64],
        box: numpy.typing.NDArray[numpy.float64],
        mol_idxs: numpy.typing.NDArray[numpy.int32],
        quaternions: numpy.typing.NDArray[numpy.float64],
        translation: numpy.typing.NDArray[numpy.float64],
    ) -> List[List[float]]: ...
    def compute_initial_log_weights(
        self, coords: numpy.typing.NDArray[numpy.float64], box: numpy.typing.NDArray[numpy.float64]
    ) -> List[float]: ...
...
class BoundPotential:
    ...
    def execute_batch(
        self,
        coords: numpy.typing.NDArray[numpy.float64],
        boxes: numpy.typing.NDArray[numpy.float64],
        compute_du_dx: bool,
        compute_u: bool,
    ) -> tuple: ...
    def execute_fixed(
...
class CentroidRestraint_f32(Potential):
    def __init__(
        self,
        group_a_idxs: numpy.typing.NDArray[numpy.int32],
        group_b_idxs: numpy.typing.NDArray[numpy.int32],
        kb: float,
        b0: float,
    ) -> None: ...
...
class Context:
    def __init__(
        self,
        x0: numpy.typing.NDArray[numpy.float64],
        v0: numpy.typing.NDArray[numpy.float64],
        box: numpy.typing.NDArray[numpy.float64],
        integrator: Integrator,
        bps: List[BoundPotential],
        movers: Optional[List[Mover]] = ...,
    ) -> None: ...
    ...
    def multiple_steps_local(
        self,
        n_steps: int,
        local_idxs: numpy.typing.NDArray[numpy.int32],
        store_x_interval: int = ...,
        radius: float = ...,
        k: float = ...,
        seed: int = ...,
    ) -> tuple: ...
    def multiple_steps_local_selection(
        self,
        n_steps: int,
        reference_idx: int,
        selection_idxs: numpy.typing.NDArray[numpy.int32],
        store_x_interval: int = ...,
        radius: float = ...,
        k: float = ...,
    ) -> tuple: ...
...
class LangevinIntegrator(Integrator):
    def __init__(
        self, masses: numpy.typing.NDArray[numpy.float64], temperature: float, dt: float, friction: float, seed: int
    ) -> None: ...
...
class MonteCarloBarostat(Mover):
    def __init__(
        ...
        initial_volume_scale_factor: float,
    ) -> None: ...
...
class Neighborlist_f32:
    ...
    def compute_block_bounds(
        self, coords: numpy.typing.NDArray[numpy.float64], box: numpy.typing.NDArray[numpy.float64], block_size: int
    ) -> tuple: ...
    def get_max_ixn_count(self) -> int: ...
    def get_nblist(
        self, coords: numpy.typing.NDArray[numpy.float64], box: numpy.typing.NDArray[numpy.float64], cutoff: float
    ) -> List[List[int]]: ...
...
class NonbondedAllPairs_f32(Potential):
    def __init__(
        ...
        beta: float,
        cutoff: float,
        atom_idxs_i: Optional[numpy.typing.NDArray[numpy.int32]] = ...,
...
class NonbondedExclusions_f32(Potential):
    def __init__(
        self,
        pair_idxs_i: numpy.typing.NDArray[numpy.int32],
        scales_i: numpy.typing.NDArray[numpy.float64],
        beta: float,
        cutoff: float,
    ) -> None: ...
...
class NonbondedInteractionGroup_f32(Potential):
    def __init__(
        self,
        num_atoms: int,
        row_atom_idxs_i: numpy.typing.NDArray[numpy.int32],
        beta: float,
        cutoff: float,
        col_atom_idxs_i: Optional[numpy.typing.NDArray[numpy.int32]] = ...,
        disable_hilbert_sort: bool = ...,
        nblist_padding: float = ...,
    ) -> None: ...
...
class Potential:
    ...
    def execute_batch_sparse(
        ...
        params: numpy.typing.NDArray[numpy.float64],
        boxes: numpy.typing.NDArray[numpy.float64],
        coords_batch_idxs: numpy.typing.NDArray[numpy.uint32],
        params_batch_idxs: numpy.typing.NDArray[numpy.uint32],
        compute_du_dx: bool,
        compute_du_dp: bool,
        compute_u: bool,
    ) -> tuple: ...
...
def atom_by_atom_energies_f32(
    target_atoms: numpy.typing.NDArray[numpy.int32],
    coords: numpy.typing.NDArray[numpy.float64],
    params: numpy.typing.NDArray[numpy.float64],
    box: numpy.typing.NDArray[numpy.float64],
    nb_beta: float,
...
def inner_and_outer_mols_f32(
    center_atoms: numpy.typing.NDArray[numpy.int32],
    coords: numpy.typing.NDArray[numpy.float64],
    box: numpy.typing.NDArray[numpy.float64],
    group_idxs: List[List[int]],
    radius: float,
) -> tuple: ...
def inner_and_outer_mols_f64(
    center_atoms: numpy.typing.NDArray[numpy.int32],
    coords: numpy.typing.NDArray[numpy.float64],
    box: numpy.typing.NDArray[numpy.float64],
    group_idxs: List[List[int]],
...
def rmsd_align(
    x1: numpy.typing.NDArray[numpy.float64], x2: numpy.typing.NDArray[numpy.float64]
) -> numpy.typing.NDArray[numpy.float64]: ...
def rotate_and_translate_mol_f32(
    coords: numpy.typing.NDArray[numpy.float64],
    box: numpy.typing.NDArray[numpy.float64],
    quaternion: numpy.typing.NDArray[numpy.float64],
    translation: numpy.typing.NDArray[numpy.float64],
) -> numpy.typing.NDArray[numpy.float64]: ...
def rotate_and_translate_mol_f64(
    coords: numpy.typing.NDArray[numpy.float64],
    box: numpy.typing.NDArray[numpy.float64],
    quaternion: numpy.typing.NDArray[numpy.float64],
    translation: numpy.typing.NDArray[numpy.float64],
) -> numpy.typing.NDArray[numpy.float64]: ...
def rotate_coords_f32(
    coords: numpy.typing.NDArray[numpy.float64], quaternions: numpy.typing.NDArray[numpy.float64]
) -> numpy.typing.NDArray[numpy.float64]: ...
def rotate_coords_f64(
    coords: numpy.typing.NDArray[numpy.float64], quaternions: numpy.typing.NDArray[numpy.float64]
) -> numpy.typing.NDArray[numpy.float64]: ...
