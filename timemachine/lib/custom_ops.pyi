...
class BDExchangeMove_f32(Mover):
    def __init__(self, N: int, target_mols: List[List[int]], params: numpy.typing.NDArray[numpy.float64], temperature: float, nb_beta: float, cutoff: float, seed: int, num_proposals_per_move: int, interval: int) -> None: ...
