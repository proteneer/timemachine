...
class BDExchangeMove_f32(Mover):
    def __init__(self, N: int, target_mols: List[List[int]], params: numpy.typing.NDArray[numpy.float64], temperature: float, nb_beta: float, cutoff: float, seed: int, steps_per_move: int, interval: int) -> None: ...
...
class TIBDExchangeMove_f32(BDExchangeMove_f32):
    def __init__(self, N: int, ligand_idxs: List[int], target_mols: List[List[int]], params: numpy.typing.NDArray[numpy.float64], temperature: float, nb_beta: float, cutoff: float, radius: float, seed: int, steps_per_move: int, interval: int) -> None: ...
    def acceptance_fraction(self) -> float: ...
    def last_log_probability(self) -> float: ...
    def move(self, coords: numpy.typing.NDArray[numpy.float64], box: numpy.typing.NDArray[numpy.float64]) -> tuple: ...
    def n_accepted(self) -> int: ...
