...
class MonteCarloBarostat:
    def __init__(self, N: int, pressure: float, temperature: float, group_idxs: List[List[int]], frequency: int, bps, seed: int, adaptive: bool = ...) -> None: ...
    def get_adaptive_scaling(self) -> bool: ...
    def get_interval(self) -> int: ...
    def get_volume_scaling(self) -> float: ...
    def set_adaptive_scaling(self, adaptive_scaling: bool) -> None: ...
    def set_interval(self, interval: int) -> None: ...
    def set_pressure(self, pressure: float) -> None: ...
    def set_volume_scaling(self, volume_scaling: float) -> None: ...
