...
float __device__ __forceinline__ strict_mul(float a, float b) { return __fmul_rn(a, b); }

double __device__ __forceinline__ strict_mul(double a, double b) { return __dmul_rn(a, b); }
