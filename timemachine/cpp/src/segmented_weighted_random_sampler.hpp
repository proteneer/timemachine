...
public:
    ...
    void sample_given_noise_device(
        ...
        const RealType *d_log_probabilities,
        const float *d_noise,
        float *d_gumbel_dist, // Buffer to store the gumbel distribution
        int *d_samples,
        cudaStream_t stream);
    ...
    void sample_given_noise_and_offset_device(
        ...
        const float *d_noise,                // [num_segments, vals_per_segment]
        float *d_gumbel_noise,               // [num_segments, vals_per_segment] Buffer to store the gumbel distribution
