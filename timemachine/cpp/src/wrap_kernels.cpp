...
void declare_neighborlist(py::module &m, const char *typestr)
{
    ...
    py::class_<Class>(
        ...
        .def("compute_block_bounds", [](timemachine::Neighborlist<RealType> &nblist, const py::array_t<double, py::array::c_style> &coords, const py::array_t<double, py::array::c_style> &box, int block_size) -> py::tuple
             {
                 if (block_size != 32)
                 {
        ...
        .def("get_nblist", [](timemachine::Neighborlist<RealType> &nblist, const py::array_t<double, py::array::c_style> &coords, const py::array_t<double, py::array::c_style> &box, const double cutoff) -> std::vector<std::vector<int>>
             {
                 int N = coords.shape()[0];
                 int D = coords.shape()[1];
...
void declare_context(py::module &m)
{
    ...
    py::class_<Class>(
        ...
        .def(
            "multiple_steps", [](timemachine::Context &ctxt, const py::array_t<double, py::array::c_style> &lambda_schedule, int store_du_dl_interval, int store_x_interval) -> py::tuple
            {
                // (ytz): I hate C++
        ...
        .def("set_x_t", [](timemachine::Context &ctxt, const py::array_t<double, py::array::c_style> new_x_t)
             { ctxt.set_x_t(new_x_t.data()); })
        .def(
            "multiple_steps_U", [](timemachine::Context &ctxt, const double lambda, const int n_steps, const py::array_t<double, py::array::c_style> &lambda_windows, int store_u_interval, int store_x_interval) -> py::tuple
            {
...
void declare_potential(py::module &m)
{
    ...
    py::class_<Class, std::shared_ptr<Class>>(
        ...
        py::dynamic_attr())
        .def(
            "execute", [](timemachine::Potential &pot, const py::array_t<double, py::array::c_style> &coords, const py::array_t<double, py::array::c_style> &params, const py::array_t<double, py::array::c_style> &box, double lambda) -> py::tuple
            {
        ...
        .def(
            "execute_selective", [](timemachine::Potential &pot, const py::array_t<double, py::array::c_style> &coords, const py::array_t<double, py::array::c_style> &params, const py::array_t<double, py::array::c_style> &box, double lambda, bool compute_du_dx, bool compute_du_dp, bool compute_du_dl, bool compute_u) -> py::tuple
            {
                const long unsigned int N = coords.shape()[0];
                const long unsigned int D = coords.shape()[1];
                const long unsigned int P = params.size();
            ...
            py::arg("coords"), py::arg("params"), py::arg("box"), py::arg("lam"), py::arg("compute_du_dx"), py::arg("compute_du_dp"), py::arg("compute_du_dl"), py::arg("compute_u"))
        .def(
            "execute_du_dx", [](timemachine::Potential &pot, const py::array_t<double, py::array::c_style> &coords, const py::array_t<double, py::array::c_style> &params, const py::array_t<double, py::array::c_style> &box, double lambda) -> py::array_t<double, py::array::c_style>
            {
                const long unsigned int N = coords.shape()[0];
                const long unsigned int D = coords.shape()[1];
                const long unsigned int P = params.size();
...
void declare_bound_potential(py::module &m)
{
    ...
    py::class_<Class>(
        ...
        .def(
            "execute", [](timemachine::BoundPotential &bp, const py::array_t<double, py::array::c_style> &coords, const py::array_t<double, py::array::c_style> &box, double lambda) -> py::tuple
            {
                const long unsigned int N = coords.shape()[0];
                const long unsigned int D = coords.shape()[1];
        ...
        .def(
            "execute_fixed", [](timemachine::BoundPotential &bp, const py::array_t<double, py::array::c_style> &coords, const py::array_t<double, py::array::c_style> &box, double lambda) -> const py::array_t<uint64_t, py::array::c_style>
            {
                const long unsigned int N = coords.shape()[0];
                const long unsigned int D = coords.shape()[1];
...
void declare_nonbonded(py::module &m, const char *typestr)
{
    ...
    py::class_<Class, std::shared_ptr<Class>, timemachine::Potential>(
        ...
        .def(py::init([](
             ...
             py::arg("exclusion_i"), py::arg("scales_i"), py::arg("lambda_plane_idxs_i"), py::arg("lambda_offset_idxs_i"), py::arg("beta"), py::arg("cutoff"), py::arg("transform_lambda_charge") = "lambda", py::arg("transform_lambda_sigma") = "lambda", py::arg("transform_lambda_epsilon") = "lambda", py::arg("transform_lambda_w") = "lambda");
}
