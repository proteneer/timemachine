...
template <typename RealType> class SmoothcoreNonbondedInteractionGroup : public Potential {
...
private:
    ...
    double *d_rescaled_x_; // rescaled coordinates
