...
nvcc --use_fast_math --ptxas-options=-v -lineinfo -arch=sm_72 -O3 -Xcompiler="-fPIC" -std=c++11 integrator.cu nonbonded_gpu.cu bonded_gpu.cu gpu_utils.cu context.cu -c
